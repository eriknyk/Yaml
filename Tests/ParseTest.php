...
class ParseTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testEscapedQuotes2()
    {
        $this->assertEquals( "that's my value.", $this->yamlContent[12]);
    }

    public function testEscapedQuotes3()
    {
    ...
    public function testReallyLargeNumber()
    {
        $this->assertEquals(
            ...
            $this->yamlContent['a_really_large_number']
        );
    }
    ...
    public function testArrayOnSeveralLines()
    {
        $this->assertEquals(
            ...
            $this->yamlContent['array on several lines']
        );
    }
    ...
    {
        $this->assertEquals(
            array(array('row' => 0, 'col' => 0, 'func' => array('tx' => array(0, 1)))),
            $this->yamlContent['switches']
        );
    }
    ...
    public function testMultilines()
    {
        $this->assertSame(
            array(
                array('type' => 'SomeItem', 'values' => array('blah', 'blah', 'blah', 'blah'),
                'ints' => array(2, 54, 12, 2143))
            ),
            $this->yamlContent['multiline_items']
        );
    }
